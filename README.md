...
Sentiment analysis on the Sentiment140 dataset using Logistic Regression, Naive Bayes, LSTM, and BERT. Compares the performance of traditional ML, deep learning, and transformer models, with BERT achieving the highest accuracy for tweet sentiment classification.
